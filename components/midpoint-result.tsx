...
export default function MidpointResult({ station1, station2 }: MidpointResultProps) {
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col items-center text-center">
          <div className="flex items-center space-x-2 mb-2">
            <div className="px-3 py-1 rounded-full bg-muted text-sm font-medium">{station1}</div>
            <div className="text-muted-foreground">と</div>
            <div className="px-3 py-1 rounded-full bg-muted text-sm font-medium">{station2}</div>
          </div>
          ...
          <div className="bg-primary/10 rounded-lg p-4 mb-4 w-full">
            <div className="flex items-center justify-center">
              ...
              <span className="text-2xl font-bold text-primary">{midpoint}</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full"
            onClick={() => {
              window.open(`https://www.google.com/maps/search/?api=1&query=${midpoint}駅`, "_blank")
            }}
          >
